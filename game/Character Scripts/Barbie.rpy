...
label Barbie_AcceptGift:
  ...
  init:
    $Cheerses = ["Cheers","Hooroo","Up the bum no babies!","Cheers me *hic* dears!","You... you me besht mate, mate...*urp* Might throw up in mo..."]
    $cheersnum = 0
...
label Barbie_AcceptGift_revisit:
  ...
  label Barbie_Talk:
    menu barbchoices if not 'pink' in list(barbchoices):
      "I thought prawns only turned pink when you cooked them?":
      ...
      "Do I detect an antipodean accent?" if not 'aussue' in list(barbchoices):
        ...
        npc "Moved out here to get away from the 50% booze tax. It just makes  you landos so much less likely to share your tinnies"
        $barbquestions.append("aussie")
